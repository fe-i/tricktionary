...
const Layout: React.FC<React.PropsWithChildren<{ noHeader?: boolean }>> = ({
  ...
  return (
    <>
      ...
      <div className="text-text container flex flex-col items-center justify-center gap-12 px-6 py-16">
        ...
        {noHeader ? (
          ...
          <div className="container absolute left-auto right-auto top-0 flex justify-between px-6 py-6">
